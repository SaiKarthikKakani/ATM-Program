...
public class HomePage {
	...
	public void enterOriginAndDestination(String origin, String destination)
		...
		System.out.println("Entered the Origin as " + origin + " and Destination as " + destination);
	}
	...
	public void enterStartAndEndDate() throws Exception {
		...
		System.out.println("Used the existing onward and return dates");
	}
	...
	public void setNumberOfPassengers() throws Exception {
		...
		System.out.println("Select 2 adult, 2 children, and 2 baby passengers");
	}
	...
	public void selectFamilyType(String familyType) {
		...
		System.out.println("Selected the " + familyType + " resident type");
	}

	public void searchFlights() {
		System.out.println("Clicked on the Search Flights button");
		searchFlights.click();
	}
